...
export const HOUSING_QUESTIONS = Object.freeze([
    { id: 'preferredRegion', title: '어떤 지역에 살고 싶나요?', type: 'region' },
    { id: 'householdType', title: '함께 사는 가구원 형태를 알려주세요', type: 'choice', options: ['1인', '부부', '자녀 포함', '기타'] },
    { id: 'homelessStatus', title: '현재 무주택자 상태인가요?', type: 'choice', options: ['no-home', 'owns-home', 'unknown'] },
    { id: 'ageBand', title: '청약 확인을 위한 나이 구간을 선택해주세요', type: 'choice', options: ['under-19', '19-34', '35-64', '65-plus'] },
    { id: 'incomeBand', title: '가구 월소득 구간을 선택해주세요', type: 'choice', options: ['under-200', '200-350', '350-500', 'over-500', 'unknown'] },
    { id: 'assetBand', title: '가구 자산 구간을 선택해주세요', type: 'choice', options: ['under-10000', '10000-25000', '25000-35000', 'over-35000', 'unknown'] },
    { id: 'currentHousingCost', title: '현재 월 주거비 구간을 선택해주세요', type: 'choice', options: ['none', 'under-30', '30-60', '60-100', 'over-100'] },
]);
